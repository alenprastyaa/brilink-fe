      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div class="mt-6 lg:mt-0">
            <button @click="((showCreateModal = true), resetNewUserForm())"
              class="group inline-flex items-center px-6 py-3 bg-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-4 focus:ring-blue-500/50 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
              ...
              <tr v-for="user in users" :key="user.user_id"
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold capitalize"
                    ...
                    <svg v-if="user.role === 'admin'" class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right">
                  <div class="flex items-center justify-end space-x-2">
                    ...
                    <button @click="handleDeleteUser(user)" :disabled="isDeleting"
                      ...
                      title="Hapus">
                      <svg v-if="isDeleting" class="w-5 h-5 animate-spin" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15">
                        </path>
                      </svg>
                      <svg v-else class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div v-if="showCreateModal"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
          ...
          <form @submit.prevent="handleCreateUser" class="p-6 space-y-4">
            <FormField label="Username" type="text" v-model="newUser.username" placeholder="Masukkan username"
              required />
            <FormField label="Password" type="password" v-model="newUser.password" placeholder="Masukkan password"
              required />
            <FormField label="Role" type="select" v-model="newUser.role" :options="roles" placeholder="Pilih peran"
              required />
            <div class="flex justify-end space-x-3 pt-4">
              ...
              <button type="submit" :disabled="isSubmitting"
                class="px-6 py-2.5 bg-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 disabled:opacity-50 transition-all duration-200 transform hover:scale-105">
      ...
      <div v-if="showEditModal"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
          ...
          <form @submit.prevent="handleEditUser" class="p-6 space-y-4">
            <FormField label="Username" type="text" v-model="editUser.username" placeholder="Masukkan username"
              required />
            <FormField label="Password Baru (Opsional)" type="password" v-model="editUser.password"
              placeholder="Kosongkan jika tidak ingin diubah" />
            <FormField label="Role" type="select" v-model="editUser.role" :options="roles" placeholder="Pilih peran"
              required />
            <div class="flex justify-end space-x-3 pt-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all">
          ...
          <div class="p-6">
            ...
            <div class="space-y-4">
              ...
              <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4">
                <div class="flex justify-between items-center">
                  ...
                  <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold capitalize"
                    ...
                    <svg v-if="selectedUser.role === 'admin'" class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714-2.143L13 3l-2.286 5.857L5 12l5.714 2.143L13 21l2.286-5.857L21 12l-5.714-2.143z">
                      </path>
              ...
              <div v-if="selectedUser.updated_at" class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4">
                <div class="flex justify-between items-center">
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-100 mt-6">
              ...
              <button @click="((showDetailModal = false), openEditModal(selectedUser))"
